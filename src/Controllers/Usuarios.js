  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p class="message">Gracias por registrarte en Localy MX. Para comenzar a disfrutar de todos nuestros servicios, necesitamos que verifiques tu dirección de correo electrónico.</p>
        <p class="message">Haz clic en el siguiente botón para completar la verificación:</p>
        
        <div class="button-container">
          <a href="${back_URL}/api/usuarios/verificar-email?tramite=${
          tramiteId.id
        }&token=${tokenVerificacion}" class="verify-button">
            Verificar mi correo
          </a>
        </div>
      </div>
      <div class="footer">
        ...
        <p class="disclaimer">Si no solicitaste crear una cuenta en Localy MX, puedes ignorar este mensaje.</p>
      </div>
    </div>
  </body>
  </html>
