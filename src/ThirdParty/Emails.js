class Emails {
  ...
  verificacionCambioContrasena(usuario, URL) {
    return `
        <!DOCTYPE html>
        <html lang="es">
        <head>
            <meta charset="UTF-8" />
            <meta name="viewport" content="width=device-width, initial-scale=1.0" />
            <title>Restablece tu contraseña - Localy MX</title>
            <style>
            body {
                margin: 0;
                padding: 0;
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    <p class="greeting">Hola${usuario ? " " + usuario : ""},</p>
                    <p class="message">
                        Hemos recibido una solicitud para restablecer tu contraseña en Localy MX.
                    </p>
                    <p class="message">
                        Si fuiste tú, haz clic en el siguiente botón para crear una nueva contraseña.
                        Este enlace es válido por 1 hora o hasta que cambies la contraseña.
                    </p>

                    <div class="button-container">
                        <a href="${URL}" class="verify-button"> Restablecer contraseña </a>
                    </div>
                ...
                <div class="footer">
                    ...
                    <p class="disclaimer">
                        Por seguridad, este enlace expirará en 60 minutos o hasta que cambies la contraseña.
                    </p>
                </div>
            </div>
        </body>
